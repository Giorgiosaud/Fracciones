    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 gap-4 sm:gap-6 md:gap-8 overflow-y-auto">
      ...
      >
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          <input
            className="bg-[#16162A] rounded-xl px-2 sm:px-4 py-2 sm:py-3 text-white text-center text-base sm:text-lg md:text-xl font-black focus:outline-none border-3 border-transparent focus:border-[#1D9BF0] transition-colors"
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          <input
            className="bg-[#16162A] rounded-xl px-2 sm:px-4 py-2 sm:py-3 text-white text-center text-base sm:text-lg md:text-xl font-black focus:outline-none"
